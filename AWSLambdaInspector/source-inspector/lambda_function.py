...
def lambda_handler(event, context):
        ...
        for function in page["Functions"]:
            ...
            try:
                ...
                if "AppVersion" in tags:
                        ...
                        MetricData=[
                            {
                                ...
                                + [{"Name": "AppVersion", "Value": str(app_version)}],
                                "Value": 1,
                                "Unit": "Count",
                            }
                        ],
                    ...
                    print(
                        f"Published metric for {function_name} AppVersion {app_version}, Stack {stack}"
                    )
    ...
    for env, service, stack, terraform in services:
        ...
        print(
            f"Published terraformTag metric for Service {service}, Stack {stack} , Env {env} , TerraformVersion {terraform}"
        )
